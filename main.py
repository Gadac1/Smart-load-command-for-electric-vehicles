...
## Affichage DeltaV
plt.plot(Time_Day, V-Delta_U_1_no_ev, 'r')
plt.plot(Time_Day, V-Delta_U_2_no_ev, 'r')
plt.plot(Time_Day, V-Delta_U_3_no_ev, 'r')
plt.plot(Time_Day, V-Delta_U_1_ev_naif, 'g')
plt.plot(Time_Day, V-Delta_U_2_ev_naif, 'g')
plt.plot(Time_Day, V-Delta_U_3_ev_naif, 'g')
plt.plot(Time_Day, V-Delta_U_1_ev_smart, 'b')
plt.plot(Time_Day, V-Delta_U_2_ev_smart, 'b')
plt.plot(Time_Day, V-Delta_U_3_ev_smart, 'b')
plt.title("Tension dans les trois branches")
plt.xlabel("Temps")
plt.ylabel("Volt (V)")
plt.show()
